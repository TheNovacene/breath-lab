...
const BreathDashboard = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      const duration = Object.values(pattern.timing).reduce((a, b) => a + b, 0);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 text-lg">Your nervous system control center</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="text-xs text-white/40">
                  ...
                  {pattern.timing.hold1 > 0 && ` • ${pattern.timing.hold1}s hold`}
                  {` • ${pattern.timing.exhale}s out`}
                  {pattern.timing.hold2 > 0 && ` • ${pattern.timing.hold2}s hold`}
                </div>
